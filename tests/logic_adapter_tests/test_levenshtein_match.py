...
from chatterbot.adapters.logic import LevenshteinMatchAdapter
...
class MockContext(object):
    def __init__(self):
        ...
        self.storage.get_random = Mock(
            side_effect=LevenshteinMatchAdapter.EmptyDatasetException()
        )


class LevenshteinMatchAdapterTests(TestCase):

    def setUp(self):
        self.adapter = LevenshteinMatchAdapter()
    ...
    def test_no_choices(self):
        ...
        with self.assertRaises(LevenshteinMatchAdapter.EmptyDatasetException):
